...
RDFArchitect is a browser-based editor for **RDFS schemas with CIM extensions** and their **SHACL constraints**. It is designed around the daily work of the CIM community: importing a profile, inspecting its package and class structure, making controlled changes, defining SHACL rules, comparing releases, planning a migration, and sharing the result.
