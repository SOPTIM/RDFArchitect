...
class WorkspaceValidationServiceTest extends WorkspaceValidationTestBase {
    ...
    void validate_unreadableSchema_reportsReadFailure() {
        ...
        assertThat(report.getIssues())
                ...
                .satisfies(
                        issue -> {
                            assertThat(issue.getKind()).isEqualTo(IssueKind.INFRASTRUCTURE);
                            assertThat(issue.getRuleId()).isNull();
                            assertThat(issue.getRuleLabel()).isEqualTo("Unreadable resource");
    ...
    void validate_failingRule_reportsWarningAndRunsOtherRules() {
        ...
        assertThat(report.getIssues().getLast().getSeverity())
