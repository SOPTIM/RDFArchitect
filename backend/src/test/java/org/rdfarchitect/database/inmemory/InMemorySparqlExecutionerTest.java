...
class InMemorySparqlExecutionerTest {
    ...
    void executeSingleQuery_onDefaultWithValidAllQuery_shouldReturnAllResults() {
        ...
        // Act
        var resultSet = InMemorySparqlExecutioner.executeSingleQuery(graphRewindable, query, graphUri);
    ...
    void executeSingleUpdate_onDefaultWithValidUpdate_shouldUpdateGraph() {
        ...
        for (var t : exampleGraphs.get(0).find().toList()) {
            var update = new UpdateBuilder()
                      ...
                      .build();
            InMemorySparqlExecutioner.executeSingleUpdate(graphRewindable, update, graphUri);
        }
