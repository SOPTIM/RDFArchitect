...
public class PackageRESTController {
    ...
    public String replacePackage(
        ...
        replacePackageUseCase.replacePackage(new GraphIdentifier(datasetName, extendedGraphURI), packageDTO);
    ...
    public String deletePackage(
        ...
        deletePackageUseCase.deletePackage(new GraphIdentifier(datasetName, extendedGraphURI), packageUUID);
