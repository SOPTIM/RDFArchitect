...
import org.rdfarchitect.services.select.ListCustomDiagramsForGraphUseCase;
...
public class AllCustomDiagramsRESTController {
    ...
    private final ListCustomDiagramsForGraphUseCase listCustomDiagramsForGraphUseCase;
    ...
    public List<CustomDiagram> getCustomDiagramList(
        ...
        var result = listCustomDiagramsForGraphUseCase.listCustomDiagramsForGraph(new GraphIdentifier(datasetName, extendedGraphURI));
