...
public interface SchemaComparisonUseCase {
     ...
     */
    List<PackageChange> compareSchemas(GraphIdentifier graphIdentifier, MultipartFile file);
     ...
     * @return A list changes structured by Package and Class representing the differences between the schemas.
     */
    List<PackageChange> compareSchemas(GraphIdentifier graphIdentifier, GraphIdentifier otherGraphIdentifier);
     ...
     * @return A list changes structured by Package and Class representing the differences between the schemas.
     */
    List<PackageChange> compareSchemas(MultipartFile file1, MultipartFile file2);
}
