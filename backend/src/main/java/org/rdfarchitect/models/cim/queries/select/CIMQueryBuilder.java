...
public class CIMQueryBuilder {
    ...
    /**
     * Constructor for the {@link CIMQueryBuilder}, provide a {@link SelectBuilder baseQuery}, which
     * assigns the subject uri to the {@code URI_VAR}.
     *
    ...
    private void initInverseSubquery() {
        this.inverseSubquery =
                new SelectBuilder()
                        .addWhere(
                                CIMQueryVars.URI,
                                CIMS.inverseRoleName,
                                CIMQueryVars.INVERSE_ROLE_NAME);
    }
    ...
    private CIMQueryBuilder appendInverseSingleQuery(
            Object predicate, String objectVar, Mode mode) {
        return appendSingleQuery(CIMQueryVars.INVERSE_ROLE_NAME, predicate, objectVar, mode);
    }

    private CIMQueryBuilder appendSingleQuery(
            String subjectVar, Object predicate, String objectVar, Mode mode) {
    ...
    private CIMQueryBuilder appendDoubleQueryWithUUID(
            Object primaryRelation,
            String primaryVariable,
            Object secondaryRelation,
            String secondaryVariable,
            String secondaryUUIDVariable,
            Mode mode) {
        baseQuery.addVar(primaryVariable).addVar(secondaryVariable).addVar(secondaryUUIDVariable);
        if (mode == Mode.REQUIRED) {
            baseQuery
    ...
    private CIMQueryBuilder appendDoubleQuery(
            Object primaryRelation,
            String primaryVariable,
            Object secondaryRelation,
            String secondaryVariable,
            Mode mode) {
        baseQuery.addVar(primaryVariable).addVar(secondaryVariable);
        if (mode == Mode.REQUIRED) {
            baseQuery
                    .addWhere(CIMQueryVars.URI, primaryRelation, primaryVariable)
                    .addOptional(primaryVariable, secondaryRelation, secondaryVariable);
    ...
    /**
     * Appends query for domains by querying for {@link CIMQueryVars DOMAIN_URI}, {@link
     * CIMQueryVars DOMAIN_LABEL} and {@link CIMQueryVars DOMAIN_UUID}.
     *
     * @param mode Whether the result of this is mode.
     * @return {@link CIMQueryBuilder this}
     */
    public CIMQueryBuilder appendDomainQuery(Mode mode) {
        return appendDoubleQueryWithUUID(
                RDFS.domain,
                CIMQueryVars.DOMAIN_URI,
                RDFS.label,
                CIMQueryVars.DOMAIN_LABEL,
                CIMQueryVars.DOMAIN_UUID,
                mode);
    }
    ...
    /**
     * Appends query for superClasses by querying the superClassURI as {@link CIMQueryVars
     * SUPER_CLASS_URI} and the superClassLabel as {@link CIMQueryVars SUPER_CLASS_LABEL}.
     *
     * @param mode Whether the result of this is mode.
     * @return {@link CIMQueryBuilder this}
     */
    public CIMQueryBuilder appendSuperClassQuery(Mode mode) {
        return appendDoubleQuery(
                RDFS.subClassOf,
                CIMQueryVars.SUPER_CLASS_URI,
                RDFS.label,
                CIMQueryVars.SUPER_CLASS_LABEL,
                mode);
    }
    ...
    /**
     * Appends query for dataTypes by querying the dataTypeURI as {@link CIMQueryVars DATA_TYPE_URI}
     * and the dataTypeLabel as {@link CIMQueryVars DATA_TYPE_LABEL}.
     *
     * @param mode Whether the result of this is mode.
     * @return {@link CIMQueryBuilder this}
     */
    public CIMQueryBuilder appendDataTypeQuery(Mode mode) {
        return appendDoubleQuery(
                CIMS.datatype,
                CIMQueryVars.DATA_TYPE_URI,
                RDFS.label,
                CIMQueryVars.DATA_TYPE_LABEL,
                mode);
    }

    /**
     * Appends query for dataTypes by querying the dataTypeURI as {@link CIMQueryVars RANGE_URI} and
     * the dataTypeLabel as {@link CIMQueryVars RANGE_LABEL}.
     *
     * @param mode Whether the result of this is mode.
     * @return {@link CIMQueryBuilder this}
     */
    public CIMQueryBuilder appendRangeQuery(Mode mode) {
        return appendDoubleQuery(
                RDFS.range, CIMQueryVars.RANGE_URI, RDFS.label, CIMQueryVars.RANGE_LABEL, mode);
    }
    ...
    /**
     * Appends query for types by querying the typeURI as {@link CIMQueryVars TYPE_URI} and the
     * typeLabel as {@link CIMQueryVars TYPE_LABEL}.
     *
     * @param mode Whether the result of this is mode.
     * @return {@link CIMQueryBuilder this}
     */
    public CIMQueryBuilder appendTypeQuery(Mode mode) {
        return appendDoubleQuery(
                RDF.type, CIMQueryVars.TYPE_URI, RDFS.label, CIMQueryVars.TYPE_LABEL, mode);
    }

    /**
     * Appends query for packages by querying for {@link CIMQueryVars PACKAGE_URI} and {@link
    ...
    /**
     * Appends query for multiplicity of objects connected via "cims:inverseRoleName" as {@link
     * CIMQueryVars Inverse.MULTIPLICITY}.
     *
     * @param mode Whether the result of this is mode.
     * @return {@link CIMQueryBuilder this}
     */
    ...
    /**
     * Appends query for associationUsed of objects connected via "cims:inverseRoleName" as {@link
     * CIMQueryVars Inverse.ASSOCIATION_USED}.
     *
     * @param mode Whether the result of this is mode.
     * @return {@link CIMQueryBuilder this}
     */
    public CIMQueryBuilder appendInverseAssociationUsedQuery(Mode mode) {
        return appendInverseSingleQuery(
                CIMS.associationUsed, CIMQueryVars.Inverse.ASSOCIATION_USED, mode);
    }

    /**
     * Appends query for comments of objects connected via "cims:inverseRoleName" as {@link
     * CIMQueryVars Inverse.COMMENT}.
     *
     * @param mode Whether the result of this is mode.
     * @return {@link CIMQueryBuilder this}
     */
