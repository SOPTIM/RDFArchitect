...
public class CIMQueries {
     ...
     * @param classUUIDs The possible UUIDs of the classes to retrieve, set to null to retrieve all
     *     classes.
     * @param graphURI The URI of the graph to query.
     * @return A {@link SelectBuilder} for the query.
     */
    public SelectBuilder getSpecifiedClassesQuery(
            PrefixMapping prefixMapping, String graphURI, List<String> classUUIDs) {
     ...
     * @return A {@link SelectBuilder} for the query.
     */
    public SelectBuilder getClassQuery(
     ...
     * @return A {@link SelectBuilder} for the query.
     */
    public SelectBuilder getAttributesQuery(
            PrefixMapping prefixMapping, String classUUID, String graphURI) {
        var baseQuery =
                new CIMBaseQueryBuilder()
                        .addPrefixes(prefixMapping)
                        .setGraph(graphURI)
     ...
     * @return A {@link SelectBuilder} for the query.
     */
    public SelectBuilder getAssociationPairsQuery(
            PrefixMapping prefixMapping, String classUUID, String graphURI) {
        var baseQuery =
                new CIMBaseQueryBuilder()
                        .setGraph(graphURI)
                        ...
                        .setType(RDF.Property)
                        .setDomain(classUUID)
                        .addWhereThisNotExists(
                                CIMS.stereotype.getURI(), CIMStereotypes.attribute.getURI())
                        .build();
     ...
     * @return A {@link SelectBuilder} for the query.
     */
    public SelectBuilder getAssociationsQuery(
            PrefixMapping prefixMapping, String graphURI, String classUUID) {
        var baseQuery =
                new CIMBaseQueryBuilder()
                        .setGraph(graphURI)
     ...
     * @return A {@link SelectBuilder} for the query.
     */
    public static SelectBuilder getStereotypesQuery(
            PrefixMapping prefixMapping, String classUUID, String graphURI) {
        var baseQuery =
                new CIMBaseQueryBuilder()
                        .setOrder()
        ...
        return builder.appendStereotypeQuery(REQUIRED).buildSelectBuilder();
    }
     ...
     * @return A {@link SelectBuilder} for the query.
     */
    public static SelectBuilder getSpecifiedEnumClassesQuery(
            PrefixMapping prefixMapping, String graphURI, List<String> enumUUIDs) {
        var baseQuery = getBaseEnumQuery(prefixMapping, graphURI);
    ...
    public static SelectBuilder getEnumEntryQuery(
            PrefixMapping prefixMapping, String graphURI, String enumEntryUUID) {
        var baseQuery =
                new CIMBaseQueryBuilder()
                        .addPrefixes(prefixMapping)
                        .setGraph(graphURI)
        ...
        return builder.appendTypeQuery(REQUIRED)
                .appendLabelQuery(REQUIRED)
                .appendCommentQuery(OPTIONAL)
                .appendStereotypeQuery(OPTIONAL)
                .buildSelectBuilder();
